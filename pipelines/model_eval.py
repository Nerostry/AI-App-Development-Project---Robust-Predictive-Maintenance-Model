...
def save_model_if_better(model, current_f1, min_f1_threshold=0.60, output_dir="saved_models"):
    ...
    if current_f1 >= min_f1_threshold:
        ...
        print("Model was NOT saved to 'saved_models/'.")

if __name__ == "__main__":
    model_path = "model.pt"

    # 1. Load newly trained model checkpoint
    ...
    QUALITY_BENCHMARK_F1 = 0.60  # Set your desired target score here
